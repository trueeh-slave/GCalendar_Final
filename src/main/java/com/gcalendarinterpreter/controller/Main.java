...
public class Main {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
        ...
        // Intenta cargar las credenciales del almacenamiento de datos
        Credential credential = flow.loadCredential("user");

        if (credential == null || !credential.refreshToken()) {
            // Si las credenciales son nulas o no se puede refrescar el token, autoriza nuevamente
    ...
    public static void main(String[] args) throws GeneralSecurityException, IOException {
        ...
        new LexicalAnalyzerController(view, service);
